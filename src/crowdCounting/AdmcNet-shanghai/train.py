...
if __name__ == '__main__':
    ...
    # admcnet.load_state_dict(torch.load('D:\\pythonProject\\crowdCounting\\aaa\\checkpoints\\epoch_400.param'))
    criterion = nn.MSELoss(size_average=False).to(device)
    optimizer = torch.optim.Adam(admcnet.parameters(), lr=1e-5)
